export function GoPage() {
    return (
        <p>The lyrics for "Puff, the Magic Dragon" are based on a 1959 poem by Leonard Lipton, then a 19-year-old Cornell University student.[1] Lipton was inspired by an Ogden Nash poem titled "The Tale of Custard the Dragon", about a "realio, trulio little pet dragon".[3][4][5]
        ...
        Yarrow now sings the line "A dragon lives forever, but not so little boys" as "A dragon lives forever, but not so girls and boys", to be fair to boys and girls.[6] The original poem also had a stanza that was not incorporated into the song. In it, Puff found another child and played with him. Neither Yarrow nor Lipton remembers the verse in detail, and the paper left in Yarrow's typewriter in 1959 has since been lost.[4]</p>
    )
}