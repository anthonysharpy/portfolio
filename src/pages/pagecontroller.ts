...
export class PageController {
    public static getRoutes(): Page[] {
        return [
            ...
            new Page("react", "React/Angular/Vue", ReactPage(), new Color("rgb(131, 171, 185)"), new Color('white'), new Color('white'), new Color('#4d7057')),
    ...
    public static getPage(pageIdentifier: string): Page {
        let page = PageController.getRoutes()?.find(x => x.identifer === pageIdentifier)
