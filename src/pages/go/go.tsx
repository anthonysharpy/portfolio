...
export function GoPage() {
    return (
        <>
            ...
            <p>With one eyebrow raised, one of the things they said was <i>"So, well, have you for example used things like concurrency in Go?"</i>. I said that I hadn't, but that I had done it in other languages, and said I didn't imagine it would be too hard. They laughed and said <i>"Yeah, right"</i>.</p>
            ...
            <p>So how <em>do</em> you deal with concurrency - specifically, concurrent access? Well, personally, as much as I hate them in just about any other context, I think implementing getters and setters is actually a perfect way to guard concurrent access. For example:</p>
            <pre>
