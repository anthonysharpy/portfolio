export function CCPlusPlusPage() {
    return (
        <>
            ...
            <p>Once I could read (and sometimes write) the program's memory I was able to use the Windows API to create routines that would perform keypresses. I also made a rudimentary UI for the game using the Windows API.</p>
