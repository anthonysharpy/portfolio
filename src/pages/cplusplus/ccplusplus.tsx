export function CCPlusPlusPage() {
    return (
        <>
            ...
            <p>A few years ago I contributed some bug fixes for the GNU C++ compiler. Although it was quite arguably the hardest thing I've ever done, I won't blabber on about it at length. You can see for yourself below some of the things I did.</p>
